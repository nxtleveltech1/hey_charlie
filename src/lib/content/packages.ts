...
const packageData: z.input<typeof packageSchema>[] = [
  ...
  },
  {
    ...
    seasonNote:
      "Run as a custom, weather-dependent tour. Winter (May–September) brings the biggest swell and the most dramatic coastline; departures are confirmed on the day based on sea state.",
    category: "shipwreck",
    offSeason: true,
  ...
  },
  {
    ...
    priceUnit: "request",
    durationHours: 0,
    durationLabel: "Per event / on request",
    minGuests: 1,
    maxGuests: 50,
    departurePoint: "By arrangement (mobile — shore-based, not a boat charter)",
    bestSeason: "Year-round, by arrangement.",
    seasonNote:
      "Offered on request as a partner service to jetski tour operators and beach or coastal events. Popular through the cooler months when a sheltered dry base is most welcome, but available year-round.",
  ...
  },
  {
    ...
    seasonNote:
      "Available year-round and into the off-season. Feasibility, timing and any permits are assessed per enquiry based on the request and conditions.",
    category: "custom",
    offSeason: true,
    byRequest: true,
    bestFor: [
