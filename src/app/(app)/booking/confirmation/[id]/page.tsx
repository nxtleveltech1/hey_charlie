    ...
    <PublicPageShell active="packages" showStickyActions={false}>
      <section className="section-pad pt-28 lg:pt-36">
        <div className="narrow-shell">
          ...
          {isProvisional && !bankDetails && (
            <div className="glass-panel mb-6 rounded-2xl border border-[var(--theme-border)] p-5 lg:p-6 light-card">
              <h2 className="mb-2 text-lg font-semibold">EFT payment details</h2>
              <p className="text-[var(--theme-text-muted)]">
                Banking details will be provided with your booking quotation.
                Use booking number{" "}
                <span className="font-mono font-semibold text-[var(--theme-text)]">
                  {booking.bookingNumber}
                </span>{" "}
                as your payment reference. Your reservation is held until{" "}
                {holdExpiresLabel}.
              </p>
            </div>
          )}
